...
function createTextRules(levelGame) {
    switch (levelGame) {
        case 0:
            return "Makan 15 apel untuk menyelesaikan misi. Saat kamu memakan 15 apel, maka gerbang kemenangan akan muncul. Memasuki gerbang akan memenangkan level. Perhatikan bahwa Anda tidak boleh membiarkan ular menusuk tubuhnya!";
        case 1:
            return "Makan 15 apel untuk menyelesaikan misi, makan 15 apel, maka gerbang kemenangan akan muncul. Memasuki gerbang akan memenangkan level. Perlu diperhatikan bahwa Anda tidak boleh membiarkan ular menabrak tubuh ular atau tembok";
        case 2:
            return "Makan 15 apel untuk menyelesaikan misi, makan 15 apel, gerbang kemenangan akan muncul. Memasuki gerbang akan memenangkan level. Perhatikan bahwa level ini memiliki waktu yang ditentukan untuk menyelesaikan putaran, jadi jika Anda tidak datang tepat waktu, Anda akan gagal dalam putaran ini dan jangan biarkan ular menabrak tubuh ular dan dinding.";
        case 3:
            return "Makan 15 apel untuk menyelesaikan misi, makan 15 apel, gerbang kemenangan akan muncul. Memasuki gerbang akan memenangkan level. Perhatikan bahwa ular akan memiliki jangka waktu untuk hidup, jadi Anda harus memakan apel dengan cepat untuk mendapatkan kembali masa hidupnya. Jika waktu hidup Anda habis tanpa menyelesaikan tugas, Anda akan gagal dalam putaran tersebut dan jangan biarkan ular itu mengenainya. tubuh dan dinding ular.";
        case 4:
            return "Selesaikan tugas memakan item dalam putaran dalam jangka waktu yang ditentukan. Setiap makan 2 buah apel akan muncul item yang bertahan selama 10 detik, usahakan selesaikan misi dan hati-hati jangan sampai ular mengenai badan atau tembok ular.";
        case 5:
            return "Makan 10 apel dan selesaikan tugas memakan item dalam waktu yang ditentukan untuk menang. Perhatikan bahwa medannya akan lebih sulit dan ular akan punya waktu untuk hidup. Manfaatkan waktu dan jarak terpendek untuk menang. Jika ular memasuki gerbang tanpa menyelesaikan misi item, Anda tetap kalah!";
    }
    return "";
}
//slider speed
